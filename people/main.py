...
if __name__ == '__main__':
    ...
    # capture = cv2.VideoCapture('TownCentreXVID.avi')#r'video\test.mp4'
    ...
    # host_ip = '192.168.31.125'# Standard loopback interface address (localhost)
    host_ip ='210.70.179.190'
    port = 10055
